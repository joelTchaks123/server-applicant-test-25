...
public enum SecondOperator {
    ...
    EQUAL {
        public <T> Predicate build(Join<Object,Object> join, CriteriaBuilder cb, FilterRequest request, Predicate predicate) {
    ...
    BETWEEN {
        public <T> Predicate build(Join<Object, Object> join, CriteriaBuilder cb, FilterRequest request, Predicate predicate) {
            ...
            if (request.getFieldType() == FieldType.DATE) {
                ...
                Expression<LocalDateTime> key = join.get(request.getKey());
            ...
            if (request.getFieldType() != FieldType.CHAR && request.getFieldType() != FieldType.BOOLEAN) {
                ...
                Expression<Number> key = join.get(request.getKey());
...
//            log.info("Can not use between for {} field type.", request.getFieldType());
    ...
    public abstract <T> Predicate build(Join<Object, Object> join, CriteriaBuilder cb, FilterRequest request, Predicate predicate);
